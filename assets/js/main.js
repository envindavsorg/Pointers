...
$(function() {
    ...
    $(document).mousemove(function(e) {
        ...
        $(".pointer-play")
            .on("mouseenter", function() {
                $('.pointer').addClass("play")
            })
            .on("mouseleave", function() {
                $('.pointer').removeClass("play")
            })

        $(".pointer-mouse-alt")
            .on("mouseenter", function() {
                $('.pointer').addClass("mouse-alt")
            })
            .on("mouseleave", function() {
                $('.pointer').removeClass("mouse-alt")
            })

        $(".pointer-eye")
            .on("mouseenter", function() {
                $('.pointer').addClass("eye")
            })
            .on("mouseleave", function() {
                $('.pointer').removeClass("eye")
            })

        $(".pointer-long-arrow-down")
            .on("mouseenter", function() {
                $('.pointer').addClass("long-arrow-down")
            })
            .on("mouseleave", function() {
                $('.pointer').removeClass("long-arrow-down")
            })

        $(".pointer-long-arrow-left")
            .on("mouseenter", function() {
                $('.pointer').addClass("long-arrow-left")
            })
            .on("mouseleave", function() {
                $('.pointer').removeClass("long-arrow-left")
            })

        $(".pointer-long-arrow-right")
            .on("mouseenter", function() {
                $('.pointer').addClass("long-arrow-right")
            })
            .on("mouseleave", function() {
                $('.pointer').removeClass("long-arrow-right")
            })

        $(".pointer-home-lg-alt")
            .on("mouseenter", function() {
                $('.pointer').addClass("home-lg-alt")
            })
            .on("mouseleave", function() {
                $('.pointer').removeClass("home-lg-alt")
            })

        $(".pointer-paper-plane")
            .on("mouseenter", function() {
                $('.pointer').addClass("paper-plane")
            })
            .on("mouseleave", function() {
                $('.pointer').removeClass("paper-plane")
            })

        $(".pointer-pen-fancy")
            .on("mouseenter", function() {
                $('.pointer').addClass("pen-fancy")
            })
            .on("mouseleave", function() {
                $('.pointer').removeClass("pen-fancy")
            })
